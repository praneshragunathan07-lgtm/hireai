...
function CollapsibleSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("card-elevated rounded-xl overflow-hidden", className), children: [
      ...
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
            icon && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-shrink-0 text-primary", children: icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                ...
                badge && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-shrink-0", children: badge })
              ] }),
              subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-0.5 truncate", children: subtitle })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-shrink-0 text-muted-foreground ml-3 group-hover:text-foreground transition-smooth", children: isOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { size: 18 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { size: 18 }) })
        ]
      }
    ),
    isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pb-5 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-4", children }) })
  ] });
}
...
const GenerateInput = Record({
  "experienceLevel": Text,
  "resumeContent": Opt(Text),
  "jobRole": Text,
  "companyCulture": Text,
  "industry": Text
});
const RubricCategory = Record({
  "scoringGuide": Vec(Text),
  "criteria": Text
});
const EvaluationRubric = Record({
...
const InterviewQuestions = Record({
  "situational": Vec(Text),
  "technical": Vec(Text),
  "behavioral": Vec(Text)
});
const JobDescription = Record({
  "responsibilities": Vec(Text),
  "preferredQualifications": Vec(Text),
  "summary": Text,
  "requiredSkills": Vec(Text),
  "equalOpportunityStatement": Text
});
const CandidateAnalysis = Record({
  "strengths": Vec(Text),
  "skillGaps": Vec(Text),
  "identifiedSkills": Vec(Text),
...
const ScreeningCriteria = Record({
  "mustHave": Vec(Text),
  "redFlags": Vec(Text),
  "goodToHave": Vec(Text)
});
const RecruitmentResult = Record({
  "evaluationRubric": EvaluationRubric,
  "interviewQuestions": InterviewQuestions,
  "jobDescription": JobDescription,
  "candidateAnalysis": Opt(CandidateAnalysis),
  "candidateScore": Opt(CandidateScore),
...
Service({
  "generateRecruitmentArtifacts": Func(
    [GenerateInput],
    [Variant({ "ok": RecruitmentResult, "err": Text })],
    []
  ),
...
const idlFactory = ({ IDL: IDL2 }) => {
  const GenerateInput2 = IDL2.Record({
    "experienceLevel": IDL2.Text,
    "resumeContent": IDL2.Opt(IDL2.Text),
    "jobRole": IDL2.Text,
    "companyCulture": IDL2.Text,
    "industry": IDL2.Text
  });
  const RubricCategory2 = IDL2.Record({
    "scoringGuide": IDL2.Vec(IDL2.Text),
    "criteria": IDL2.Text
  });
  const EvaluationRubric2 = IDL2.Record({
    "communication": RubricCategory2,
    "problemSolving": RubricCategory2,
    "technical": RubricCategory2,
    "cultureFit": RubricCategory2
  });
  const InterviewQuestions2 = IDL2.Record({
    "situational": IDL2.Vec(IDL2.Text),
    "technical": IDL2.Vec(IDL2.Text),
    "behavioral": IDL2.Vec(IDL2.Text)
  });
  const JobDescription2 = IDL2.Record({
    "responsibilities": IDL2.Vec(IDL2.Text),
    "preferredQualifications": IDL2.Vec(IDL2.Text),
    "summary": IDL2.Text,
    "requiredSkills": IDL2.Vec(IDL2.Text),
    "equalOpportunityStatement": IDL2.Text
  });
  const CandidateAnalysis2 = IDL2.Record({
    "strengths": IDL2.Vec(IDL2.Text),
    "skillGaps": IDL2.Vec(IDL2.Text),
    "identifiedSkills": IDL2.Vec(IDL2.Text),
    "experienceSummary": IDL2.Text
  });
  const CandidateScore2 = IDL2.Record({
    "justification": IDL2.Text,
    "experienceScore": IDL2.Nat,
    "verdict": IDL2.Text,
    "skillsScore": IDL2.Nat,
    "totalScore": IDL2.Nat,
    "cultureFitScore": IDL2.Nat,
    "communicationScore": IDL2.Nat
  });
  const ScreeningCriteria2 = IDL2.Record({
    "mustHave": IDL2.Vec(IDL2.Text),
    "redFlags": IDL2.Vec(IDL2.Text),
    "goodToHave": IDL2.Vec(IDL2.Text)
  });
  const RecruitmentResult2 = IDL2.Record({
    "evaluationRubric": EvaluationRubric2,
    "interviewQuestions": InterviewQuestions2,
    "jobDescription": JobDescription2,
    "candidateAnalysis": IDL2.Opt(CandidateAnalysis2),
    "candidateScore": IDL2.Opt(CandidateScore2),
    "screeningCriteria": ScreeningCriteria2
  });
  ...
  return IDL2.Service({
    "generateRecruitmentArtifacts": IDL2.Func(
      [GenerateInput2],
      [IDL2.Variant({ "ok": RecruitmentResult2, "err": IDL2.Text })],
      []
    ),
...
class Backend {
  ...
  async generateRecruitmentArtifacts(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.generateRecruitmentArtifacts(to_candid_GenerateInput_n1(this._uploadFile, this._downloadFile, arg0));
...
function from_candid_RecruitmentResult_n4(_uploadFile, _downloadFile, value) {
...
function from_candid_record_n5(_uploadFile, _downloadFile, value) {
  return {
    evaluationRubric: value.evaluationRubric,
    interviewQuestions: value.interviewQuestions,
    jobDescription: value.jobDescription,
    candidateAnalysis: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.candidateAnalysis)),
    candidateScore: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.candidateScore)),
    screeningCriteria: value.screeningCriteria
  };
}
function from_candid_variant_n3(_uploadFile, _downloadFile, value) {
  return "ok" in value ? {
    __kind__: "ok",
    ok: from_candid_RecruitmentResult_n4(_uploadFile, _downloadFile, value.ok)
  } : "err" in value ? {
    __kind__: "err",
    err: value.err
  } : value;
}
function to_candid_GenerateInput_n1(_uploadFile, _downloadFile, value) {
  return to_candid_record_n2(_uploadFile, _downloadFile, value);
}
function to_candid_record_n2(_uploadFile, _downloadFile, value) {
  return {
    experienceLevel: value.experienceLevel,
    resumeContent: value.resumeContent ? candid_some(value.resumeContent) : candid_none(),
    jobRole: value.jobRole,
    companyCulture: value.companyCulture,
...
function useGenerateRecruitment() {
...
const useRecruitmentStore = create((set, get) => ({
  ...
  setResumeFile: (file, content) => set({ resumeFile: file, resumeContent: content }),
  ...
  isFormValid: () => {
    const s = get();
    return s.jobRole.trim().length > 0 && s.experienceLevel.length > 0 && s.industry.length > 0 && s.companyCulture.trim().length > 0;
  }
}));
var jt = (n) => {
  switch (n) {
...
function JobInputForm() {
  ...
  const handleDrop = async (e) => {
    ...
    if (!file.name.endsWith(".pdf") && !file.name.endsWith(".txt")) {
      ue.error("Please upload a .txt or .pdf file");
      return;
    }
    const content = await extractTextFromFile(file);
    setResumeFile(file, content);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-elevated rounded-xl p-5 space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 pb-1 border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { size: 15, className: "text-primary flex-shrink-0" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-sm text-foreground", children: "Job Details" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "job-role", className: "text-sm font-medium", children: [
        "Job Role ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "experience-level", className: "text-sm font-medium", children: [
        "Experience Level ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: experienceLevel, onValueChange: setExperienceLevel, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: EXPERIENCE_LEVELS.map((lvl) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: lvl.value, children: lvl.label }, lvl.value)) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "industry", className: "text-sm font-medium", children: [
        "Industry ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "company-culture", className: "text-sm font-medium", children: [
        "Company Culture ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      ...
      resumeFile ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground truncate", children: resumeFile.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: formatFileSize(resumeFile.size) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
        ...
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { size: 22, className: "text-muted-foreground" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground font-medium", children: "Drop file here or click to browse" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "PDF or TXT files only" })
            ] })
          ]
        }
      ),
    ...
    !valid && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center -mt-2", children: "Fill in all required fields to continue" })
  ] });
}
function Layout({ sidebarContent, mainContent }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-card border-b border-border shadow-sm sticky top-0 z-30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-screen-2xl mx-auto px-6 h-16 flex items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center w-8 h-8 rounded-lg bg-primary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { size: 16, className: "text-primary-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg text-foreground tracking-tight", children: "HireAI" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline text-xs text-muted-foreground font-body", children: "Intelligent Recruitment Powered by AI" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { size: 13, className: "text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "AI-Powered" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-muted/40 border-b border-border px-6 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-screen-2xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-semibold text-xl text-foreground", children: "New Candidate Evaluation" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-0.5", children: "Fill in the job details and optionally upload a resume to generate a complete recruitment package." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 max-w-screen-2xl mx-auto w-full px-6 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-6 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "w-80 flex-shrink-0 sticky top-[120px] max-h-[calc(100vh-136px)] overflow-y-auto", children: sidebarContent }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 min-w-0 space-y-4", "data-ocid": "results-area", children: mainContent })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border mt-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-screen-2xl mx-auto px-6 py-4 text-center text-xs text-muted-foreground", children: [
      "© ",
...
function getScoreColor(score, max2) {
  const pct = score / max2;
...
function ScoreBar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("space-y-1.5", className), "data-ocid": "score-bar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
        ...
        weight && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground flex-shrink-0", children: [
          "(",
          weight,
          ")"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-semibold text-foreground flex-shrink-0 tabular-nums", children: [
        score,
...
function normalizeVerdict(verdict) {
  const v2 = verdict.toLowerCase().trim();
  if (v2 === "strong hire" || v2 === "stronghire") return "Strong Hire";
  if (v2 === "hire") return "Hire";
  if (v2 === "maybe") return "Maybe";
  return "Reject";
}
const verdictStyles = {
...
function EmptyResults() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            width: "28",
            height: "28",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M19 3l.75 2.25L22 6l-2.25.75L19 9l-.75-2.25L16 6l2.25-.75z" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M5 18l.75 2.25L8 21l-2.25.75L5 24l-.75-2.25L2 21l2.25-.75z" })
            ]
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 max-w-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-lg", children: "Ready to generate" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm leading-relaxed", children: [
            ...
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Generate Analysis" }),
            " to receive a complete recruitment package powered by AI."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-2 mt-2", children: [
          "Job Description",
          "Screening Criteria",
          "Interview Questions",
          "Evaluation Rubric"
        ].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs", children: item }, item)) })
      ]
    }
  );
}
function ResultsPanel({ result }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", "data-ocid": "results-panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: ca ? "Full analysis with candidate evaluation" : "Job artifacts generated — upload a resume for candidate scoring" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        CollapsibleSection,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: jd.summary }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground mb-2", children: "Responsibilities" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: jd.responsibilities.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2 text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CircleCheck,
                  {
                    size: 14,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground mb-2", children: "Required Skills" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: jd.requiredSkills.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs", children: s }, s)) })
            ] }),
            jd.preferredQualifications.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground mb-2", children: "Preferred Qualifications" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: jd.preferredQualifications.map((q) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "text-muted-foreground flex gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Star,
                  {
                    size: 13,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground italic border-t border-border pt-3", children: jd.equalOpportunityStatement })
          ] })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        CollapsibleSection,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "flex items-center gap-1.5 font-semibold text-foreground mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SquareCheckBig, { size: 14, className: "text-chart-1" }),
                "Must-Have"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: sc.mustHave.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2 text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CircleCheck,
                  {
                    size: 13,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "flex items-center gap-1.5 font-semibold text-foreground mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 14, className: "text-chart-2" }),
                "Good-to-Have"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: sc.goodToHave.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2 text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Star,
                  {
                    size: 13,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "flex items-center gap-1.5 font-semibold text-foreground mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { size: 14, className: "text-destructive" }),
                "Red Flags"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: sc.redFlags.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2 text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CircleX,
                  {
                    size: 13,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CollapsibleSection,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "font-semibold text-foreground mb-3 flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Brain, { size: 14, className: "text-primary" }),
              "Technical (",
              iq.technical.length,
              ")"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "space-y-2 list-decimal list-inside", children: iq.technical.map((q) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-muted-foreground leading-relaxed", children: q }, q)) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "font-semibold text-foreground mb-3 flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(UserCheck, { size: 14, className: "text-chart-2" }),
              "Behavioral (",
              iq.behavioral.length,
              ")"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "space-y-2 list-decimal list-inside", children: iq.behavioral.map((q) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-muted-foreground leading-relaxed", children: q }, q)) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "font-semibold text-foreground mb-3 flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CircleHelp, { size: 14, className: "text-accent" }),
              "Situational (",
              iq.situational.length,
              ")"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "space-y-2 list-decimal list-inside", children: iq.situational.map((q) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-muted-foreground leading-relaxed", children: q }, q)) })
          ] })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CollapsibleSection,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm", children: rubricCategories.map(({ key, label, rubric }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground", children: label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: rubric.criteria }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: rubric.scoringGuide.map((guide, scoreIdx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-shrink-0 w-5 h-5 rounded bg-muted flex items-center justify-center text-xs font-semibold text-muted-foreground", children: scoreIdx + 1 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground leading-relaxed", children: guide })
          ] }, guide)) })
        ] }, key)) })
      }
    ),
    ca && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        CollapsibleSection,
        {
          title: "Candidate Analysis",
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(UserCheck, { size: 16 }),
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: ca.experienceSummary }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground mb-2", children: "Identified Skills" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: ca.identifiedSkills.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs", children: s }, s)) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground mb-2", children: "Strengths" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: ca.strengths.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2 text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CircleCheck,
                  {
                    size: 13,
            ...
            ca.skillGaps.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground mb-2", children: "Skill Gaps" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: ca.skillGaps.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2 text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CircleX,
                  {
                    size: 13,
      ...
      cs && /* @__PURE__ */ jsxRuntimeExports.jsx(
        CollapsibleSection,
        {
          title: "Final Score & Verdict",
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 16 }),
          badge: /* @__PURE__ */ jsxRuntimeExports.jsx(VerdictBadge, { verdict: cs.verdict, size: "sm" }),
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 text-sm", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-3 rounded-lg bg-muted/50 border border-border", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: "Total Score" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-bold font-display text-foreground tabular-nums", children: Number(cs.totalScore) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-sm", children: "/100" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground mb-1.5", children: "Verdict" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(VerdictBadge, { verdict: cs.verdict, size: "lg" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground mb-1.5", children: "Justification" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: cs.justification })
            ] })
          ] })
        }
      )
...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Layout,
    {
      sidebarContent: /* @__PURE__ */ jsxRuntimeExports.jsx(JobInputForm, {}),
      mainContent: result ? /* @__PURE__ */ jsxRuntimeExports.jsx(ResultsPanel, { result }) : /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyResults, {})
    }
  );
}
export {
